...
// GENERATED by snarkjs 0.7.6 from circuits/kyc.circom. Do not edit by hand.
// Regenerate with: snarkjs zkey export solidityverifier circuits/build/kyc.zkey
//
// DISCLOSURE: this file is machine generated third-party output, GPL-3.0, from
// iden3's snarkjs template. It is not our code and is not counted as such.
//
// WARNING, and it is not a formality. `verifyProof` returning true means the
// circuit was evaluated honestly. It does NOT mean the holder passed the policy.
// Every one of the four policy failures produces a proof that verifies here with
// public signal 1 (`passes`) equal to zero. Read that signal. `RegistrationGate`
// does, and `test_verifierAloneIsNotACheck` fails if it stops.
/*
...
contract KycVerifier {
    ...
    uint256 constant Qmx  = 1521852892866280212489795554927369027813858859755353438749747774040238916356;
    uint256 constant Qmy  = 17577968465111320782312162930568001995358828547269456250759030558440172631279;
    uint256 constant Qlx  = 5507714030192135943381468924567550993061145983370664355490713720496808762248;
    uint256 constant Qly  = 1678290192965981951324260602467331009558923341903993040563950010305533556927;
    uint256 constant Qrx  = 295536828714133216662844245783160259046273924929244455600731949270544640947;
    uint256 constant Qry  = 19894269537916302210180390293216631766634737867446721886603644698394275760730;
    uint256 constant Qox  = 4636411298857040787753558123872602235677028258242340867127313910246602649957;
    uint256 constant Qoy  = 7663840394729140745356217524879471870544330548822945618018694139186880103768;
    uint256 constant Qcx  = 3641915766479782295403651876287671394713316789225384446078222164630285840227;
    uint256 constant Qcy  = 3216360328820362051578430536555859838668727861428375053712569897029901344206;
    uint256 constant S1x  = 21315922745697339481573915304299474533327504670237225452025068696491432336613;
    uint256 constant S1y  = 20885520560564951077694089805964383395269250923484455213711554168623661154930;
    uint256 constant S2x  = 9185743551144107188342520141620109340681768343961882142247017358442765428046;
    uint256 constant S2y  = 7423771182362935470843813302192937400427714492360086407029861832045443626515;
    uint256 constant S3x  = 11769735002652536903315734859088626130461309865781021532545145887502118521382;
    uint256 constant S3y  = 13244185969656959218963901771280066477823771147977075805306151265721753398996;
